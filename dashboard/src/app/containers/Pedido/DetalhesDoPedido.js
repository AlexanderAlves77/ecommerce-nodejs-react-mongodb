    ...
    return (
      <div className="flex">
        <div className="flex-1 flex">
          <Titulo tipo="h2" titulo="Pedido - Cliente 1 - 01/09/2021" />
        </div>
  ...
  renderDadosDoCliente() {
    return (
      <div className="flex-2">
        ...
        <TextoDados chave="CPF" valor="111.222.33345" />
        <TextoDados chave="Telefone" valor="11 1234-5678" />
        <TextoDados chave="Data de Nascimento" valor="01/01/1970" />
      </div>
    )
  }
  ...
  renderDadosDeEntrega() {
    return (
      <div className="flex-2">
        ...
        <TextoDados chave="CEP" valor="01234-567" />
      </div>
    )
  }
