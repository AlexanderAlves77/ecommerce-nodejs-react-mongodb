...
class NovaVariacao extends Component {
    ...
    return (
      <div className="flex horizontal">
        <div className="flex-1">
          <Titulo
            tipo="h3"
            titulo={nome ? 'Variacao - ' + nome : 'Nova Variação'}
          />
        </div>
    ...
    return (
      <div className="Dados-Produto">
        <InputSimples
          ...
          value={codigo}
          error={erros.codigo}
          onChange={evt => this.onChangeInput('codigo', evt.target.value)}
        />
        <InputSimples
          name="nome"
          label="Nome:"
          value={nome}
          error={erros.nome}
          onChange={evt => this.onChangeInput('nome', evt.target.value)}
        />
        <InputSimples
          name="preco"
          label="Preço Padrão:"
          ...
          value={preco}
          error={erros.preco}
          onChange={evt => this.onChangeInput('preco', evt.target.value)}
        />
        <InputSimples
          name="promocao"
          ...
          onChange={evt => this.onChangeInput('promocao', evt.target.value)}
        />
        <InputSimples
          name="quantidade"
          label="Quantidade"
          ...
          onChange={evt => this.onChangeInput('quantidade', evt.target.value)}
        />
      </div>
    )
  }
  ...
  renderDadosEnvio() {
    const { peso, freteGratis, largura, comprimento, altura, erros } =
      this.state
    return (
      <div className="Dados-Produto">
        <InputSimples
          ...
          value={peso}
          error={erros.peso}
          onChange={evt => this.onChangeInput('peso', evt.target.value)}
        />
        <TextoDados
          chave="Frete Grátis?"
          valor={
        ...
        <InputSimples
          ...
          value={largura}
          error={erros.largura}
          onChange={evt => this.onChangeInput('largura', evt.target.value)}
        />
        <InputSimples
          name="comprimento"
          label="Comprimento:"
          ...
          onChange={evt => this.onChangeInput('comprimento', evt.target.value)}
        />
        <InputSimples
          name="altura"
          label="Altura:"
          ...
          value={altura}
          error={erros.altura}
          onChange={evt => this.onChangeInput('altura', evt.target.value)}
        />
      </div>
    )
  }
